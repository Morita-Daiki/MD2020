...
void StartControll(void const * argument);
...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of Controll */
  osThreadDef(Controll, StartControll, osPriorityHigh, 0, 128);
  ControllHandle = osThreadCreate(osThread(Controll), NULL);

  /* definition and creation of Communicate */
  osThreadDef(Communicate, StartCommunicate, osPriorityAboveNormal, 0, 128);
...
/* USER CODE BEGIN Header_StartControll */
/**
* @brief Function implementing the Controll thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartControll */
void StartControll(void const * argument)
{
  /* USER CODE BEGIN StartControll */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END StartControll */
}
